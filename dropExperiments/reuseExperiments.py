...
proc = "java -Xms6g ${JAVA_OPTS} -cp 'assembly/target/*:core/target/classes:frontend/target/classes:contrib/target/classes' macrobase.analysis.stats.optimizer.experiments.WorkReuseExperiments %s %f %f %d %s"
...
for dataset in datasets:
    subprocess.call(proc % (dataset, lbr, q, kExp, opt), shell=True)
